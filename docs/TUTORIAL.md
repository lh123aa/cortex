...
- [场景二：AI 总是忘记之前的讨论](#场景二ai-总是忘记之前的讨论)
- [场景三：项目文档散落一地，AI 找不到](#场景三项目文档散落一地ai-找不到)
- [场景四：重复劳动——同样的问题反复问](#场景四重复劳动同样的问题反复问)
- [场景五：团队协作——知识不共享](#场景五团队协作知识不共享)
- [场景六：生产环境——把知识库变成服务](#场景六生产环境把知识库变成服务)
- [附录：命令速查](#附录命令速查)
