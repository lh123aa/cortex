...
// Registry 自定义 Prometheus registry，支持生命周期管理
var Registry = prometheus.NewRegistry()

// registerFunc 用于将指标注册到自定义 registry
var registerFunc = promauto.With(Registry)

var (
	// IndexTotal total number of documents indexed
	IndexTotal = registerFunc.NewCounter(prometheus.CounterOpts{
		Namespace: "cortex",
		Name:      "index_total",
	...
	IndexDuration = registerFunc.NewHistogram(prometheus.HistogramOpts{
		Namespace: "cortex",
	...
	IndexErrors = registerFunc.NewCounter(prometheus.CounterOpts{
		Namespace: "cortex",
	...
	IndexChunksTotal = registerFunc.NewCounter(prometheus.CounterOpts{
		Namespace: "cortex",
	...
	SearchTotal = registerFunc.NewCounter(prometheus.CounterOpts{
		Namespace: "cortex",
		Name:      "search_total",
	...
	SearchDuration = registerFunc.NewHistogram(prometheus.HistogramOpts{
		Namespace: "cortex",
	...
	SearchCacheHits = registerFunc.NewCounter(prometheus.CounterOpts{
		Namespace: "cortex",
	...
	SearchCacheMisses = registerFunc.NewCounter(prometheus.CounterOpts{
		Namespace: "cortex",
	...
	SearchResultsReturned = registerFunc.NewHistogram(prometheus.HistogramOpts{
		Namespace: "cortex",
	...
	SearchByMode = registerFunc.NewCounterVec(prometheus.CounterOpts{
		Namespace: "cortex",
	...
	ChunkTotal = registerFunc.NewGauge(prometheus.GaugeOpts{
		Namespace: "cortex",
		Name:      "chunks_total",
	...
	DocumentTotal = registerFunc.NewGauge(prometheus.GaugeOpts{
		Namespace: "cortex",
	...
	VectorDimension = registerFunc.NewGauge(prometheus.GaugeOpts{
		Namespace: "cortex",
	...
	VectorTotal = registerFunc.NewGauge(prometheus.GaugeOpts{
		Namespace: "cortex",
		Name:      "vectors_total",
	...
	EmbeddingDuration = registerFunc.NewHistogram(prometheus.HistogramOpts{
		Namespace: "cortex",
	...
	EmbeddingErrors = registerFunc.NewCounter(prometheus.CounterOpts{
		Namespace: "cortex",
	...
	EmbeddingBatchSize = registerFunc.NewHistogram(prometheus.HistogramOpts{
		Namespace: "cortex",
	...
	HNSWIndexSize = registerFunc.NewGauge(prometheus.GaugeOpts{
		Namespace: "cortex",
	...
	SearchLatency = registerFunc.NewHistogram(prometheus.HistogramOpts{
		Namespace: "cortex",
	...
	ErrorsTotal = registerFunc.NewCounterVec(prometheus.CounterOpts{
		Namespace: "cortex",
		Name:      "errors_total",
	...
	APIRequestTotal = registerFunc.NewCounterVec(prometheus.CounterOpts{
		Namespace: "cortex",
	...
	APIRequestDuration = registerFunc.NewHistogram(prometheus.HistogramOpts{
		Namespace: "cortex",
	...
	UsersTotal = registerFunc.NewGauge(prometheus.GaugeOpts{
		Namespace: "cortex",
		Name:      "users_total",
	...
	UserDocumentsTotal = registerFunc.NewGaugeVec(prometheus.GaugeOpts{
		Namespace: "cortex",
	...
	UserVectorsTotal = registerFunc.NewGaugeVec(prometheus.GaugeOpts{
		Namespace: "cortex",
	...
	MemoryUsageBytes = registerFunc.NewGauge(prometheus.GaugeOpts{
		Namespace: "cortex",
	...
	VectorIndexMemoryBytes = registerFunc.NewGauge(prometheus.GaugeOpts{
		Namespace: "cortex",
	...
	PQCompressionRatio = registerFunc.NewGauge(prometheus.GaugeOpts{
		Namespace: "cortex",
	...
	AuthTotal = registerFunc.NewCounterVec(prometheus.CounterOpts{
		Namespace: "cortex",
		Name:      "auth_total",
	...
	AuthLatency = registerFunc.NewHistogram(prometheus.HistogramOpts{
		Namespace: "cortex",
	...
	APIKeyUsageTotal = registerFunc.NewCounterVec(prometheus.CounterOpts{
		Namespace: "cortex",
